                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.products-store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('stock') is-invalid @enderror" name="stock" id="stock" placeholder="Product stock" value="{{ old('price') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="thumbnail" class="form-control @error('path_image') is-invalid @enderror" type="text" name="path_image" readonly placeholder="Choose your file image" value="{{ old('path_image') }}">
                            </div>
