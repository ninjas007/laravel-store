                ...
                <div class="col-lg-9">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="city_id">Hanya Berlaku di kota</label>
                                <select name="city_id" id="city_id" class="form-control">
                                    <option value="0" selected class="font-weight-bold">Semua Kota</option>
                                    @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ $city->id == json_decode($shipping['setting'])->destination_city_id ? 'selected' : '' }}>{{ $city->city_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
